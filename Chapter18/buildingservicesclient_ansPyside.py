# coding: utf-8
"""
buildingservicesclient_ansPyside.py
Annotated PySide adaptation of buildingservicesclient_ans.py from Chapter 18
        ...
        while True:
            ...
            if action == "BOOKINGSFORROOM":
                ...
                for x in range(stream.readInt32()):
                    stream >> date
                    dates.append(date.toString(QtCore.Qt.ISODate))
                dates = ", ".join(dates)
            ...
            if action == "ERROR":
                ...
                msg = "Rooms booked on {0}: {1}".format(
                        date.toString(QtCore.Qt.ISODate), room)
