...
'''
helpformPyside.py
Annotated PySide adaptation of helpform.py from Chapter 17
...
class HelpForm(QtGui.QDialog):
    ...
    def __init__(self, page, parent=None):
        ...
        backAction = QtGui.QAction(QtGui.QIcon(":/back.png"), self.tr("&Back"), self)
        backAction.setShortcut(QtGui.QKeySequence.Back)
        homeAction = QtGui.QAction(QtGui.QIcon(":/home.png"), self.tr("&Home"), self)
        ...
        self.resize(400, 600)
        self.setWindowTitle(self.tr("{0} Help").format(
